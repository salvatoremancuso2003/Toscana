...
<html>
    ...
    <body>
                                ...
                                <div class="kt-portlet__body">
                                    <div class="row col-md-12">
                                        <div class="form-group col-md-3">
                                            <h6>Cognome</h6>
                                            <label><br><%=a.getCognome()%></label>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <h6>Nome</h6>
                                            <label><br><%=a.getNome()%></label>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <h6>Data di Nascita</h6>
                                            <label><br><%=Utility.sdfITA.format(a.getDatanascita())%></label>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <h6>Codice Fiscale</h6>
                                            <label><br><%=a.getCodicefiscale()%></label>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <h6>Sesso</h6>
                                            <label><br><%=a.getSesso()%></label>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <h6>Comune Nascita</h6>
                                            <label><br><%=a.getComune_nascita().getNome()%> (<%=a.getComune_nascita().getProvincia()%>) - <%=a.getComune_nascita().getRegione()%></label>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <h6>Cittadinanza</h6>
                                            <label><br><%=cittadinanza%></label>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <h6>Telefono</h6>
                                            <label><br><%=a.getTelefono()%></label>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <h6>Email</h6>
                                            <label><br><%=a.getEmail()%></label>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <h6>Data Iscrizione</h6>
                                            <label><br><%=Utility.sdfITA.format(a.getIscrizionegg())%></label>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <h6>Indirizzo Residenza</h6>
                                            <label><br><%=a.getIndirizzoresidenza()%> - <%=a.getComune_residenza().getNome()%> (<%=a.getComune_residenza().getProvincia()%>) - <%=a.getComune_residenza().getRegione()%></label>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <h6>Gruppo vulnerabilità</h6>
                                            <label><br><%=a.getTos_gruppovulnerabile().getDescrizione()%></label>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <h6>Titolo di studio</h6>
                                            <label><br><%=a.getTitoloStudio().getDescrizione()%></label>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <h6>CPI</h6>
                                            <label><br><%=a.getCpi().getDescrizione()%></label>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <h6>Data Iscrizione CPI</h6>
                                            <label><br><%=Utility.sdfITA.format(a.getDatacpi())%></label>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <h6>Condizione professionale</h6>
                                            <label><br><%=a.getCondizione_mercato().getDescrizione()%></label>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <h6>Tipo Finanziamento (GOL/PATTO)</h6>
                                            <label><br><%=a.getTos_tipofinanziamento()%></label>
                                        </div>
        ...
        <div id="kt_scrolltop" class="kt-scrolltop" style="background-color: #0021c3!important">
