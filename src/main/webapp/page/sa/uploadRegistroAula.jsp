...
<html>
    ...
    <body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed">
                            ...
                            <div class="kt-portlet kt-portlet--mobile">
                                <div class="kt-portlet__head">
                                    <div class="kt-portlet__head-label">
                                        <p>
                                            <label class="text-primary" style="padding-top: 10px; font-size: 20px;">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-5">
                                                <div class="form-group">
                                                    <h6 style="font-size: 12px" >Giorno</h6>
                                                    <input type="text" class="form-control obbligatory" name="giorno" placeholder="Giorno" id="giorno" autocomplete="off" readonly/>
                                                </div>
                                                <div class="form-group">
                                                    <label class="active" for="docente">Docente</label><label class='text-danger'>*</label>
                                                ...
                                                <div class="form-group">
                                                    <label class="active" for="range2">Ora di Inizio e Fine Lezione</label><label class="text-danger">*</label>
                                                    <input type="hidden" class="form-control" id="range">
                                                    <input type="text" class="form-control obbligatory disable-input" name="range" id="range2" readonly autocomplete="off" placeholder="Selezionare ora di inizio e fine" disabled>

                                                </div>
                                                <label class='text-danger'>per inserire Ora inizio e fine,selezionare prima il giorno della lezione</label>
                                            </div>
                                            <div class="col-lg-1">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label class="active" for="allievi">Presenti</label><label class='text-danger'>*</label>
                                                ...
                                                <label class='text-danger'>per inserire ingresso e uscita per gli alunni settare prima ora inizio e fine lezione</label>
                                                <div class="form-group">
        ...
        </div><script src="../../Bootstrap2024/assets/js/bootstrap-italia.bundle.min.js"></script>
