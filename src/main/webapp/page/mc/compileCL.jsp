                                                                    ...
                                                                    <div class="kt-wizard-v1__form kt-font-io" style="min-height: 40vh">
                                                                        <div class="row">
                                                                            <div class="form-group col-md-4 col-lg-4 col-sm-12">
                                                                                <label class="active">Soggetto Esecutore sottoposto a controllo</label>
                                                                            ...
                                                                            <div class="form-group col-md-4 col-lg-4 col-sm-12">
                                                                                <label class="active">Protocollo Soggetto Esecutore</label>
                                                                                <div class="input-group input-group-md">
                                                                                    <div class="input-group-prepend">
                                                                                        <span class="input-group-text">
                                                                            ...
                                                                            <div class="form-group col-md-4 col-lg-4 col-sm-12">
                                                                                <label class="active">Codice Identificativo Percorso</label>
                                                                                <div class="input-group input-group-md">
                                                                                    <div class="input-group-prepend">
                                                                                        <span class="input-group-text">
                                                                                            <i class="fa fa-info kt-font-io" aria-hidden="true"></i>
                                                                        ...
                                                                        <div class="row">        
                                                                            <div class="form-group col-md-12 col-lg-12 col-sm-12">
                                                                                <label class="active">Codice Fiscale / Partita IVA Soggetto Esecutore</label>
                                                                                <div class="input-group input-group-md">
                                                                                    <div class="input-group-prepend">
                                                                                        <span class="input-group-text">
                                                                                            <i class="fa fa-info kt-font-io" aria-hidden="true"></i>
                                                                        ...
                                                                        <div class="row">        
                                                                            <div class="form-group col-md-6 col-lg-6 col-sm-12">
                                                                                <label class="active">Email Soggetto Esecutore</label>
                                                                                <div class="input-group input-group-md">
                                                                                    <div class="input-group-prepend">
                                                                                        <span class="input-group-text">
                                                                            ...
                                                                            <div class="form-group col-md-6 col-lg-6 col-sm-12">
                                                                                <label class="active">PEC Soggetto Esecutore</label>
                                                                                <div class="input-group input-group-md">
                                                                                    <div class="input-group-prepend">
                                                                                        <span class="input-group-text">
                                                                                            <i class="fa fa-mail-bulk kt-font-io" aria-hidden="true"></i>
                                                                        ...
                                                                        <div class="row">        
                                                                            <div class="form-group col-md-6 col-lg-6 col-sm-12">
                                                                                <label class="active">Data avvio effettiva</label>
                                                                                <div class="input-group input-group-md">
                                                                                    <div class="input-group-prepend">
                                                                                        <span class="input-group-text">
                                                                            ...
                                                                            <div class="form-group col-md-6 col-lg-6 col-sm-12">
                                                                                <label class="active">Data conclusione effettiva</label>
                                                                                <div class="input-group input-group-md">
                                                                                    <div class="input-group-prepend">
                                                                                        <span class="input-group-text">
                                                                                            <i class="fa fa-calendar-check kt-font-io" aria-hidden="true"></i>
                                                                        ...
                                                                        <div class="row">        
                                                                            <div class="form-group col-md-6 col-lg-6 col-sm-12">
                                                                                <label class="active">Numero allievi iscritti</label>
                                                                                <div class="input-group input-group-md">
                                                                                    <div class="input-group-prepend">
                                                                                        <span class="input-group-text">
                                                                            ...
                                                                            <div class="form-group col-md-6 col-lg-6 col-sm-12">
                                                                                <label class="active">Numero allievi che hanno terminato il percorso</label>
                                                                                <div class="input-group input-group-md">
                                                                                    <div class="input-group-prepend">
                                                                                        <span class="input-group-text">
                                                                                            <i class="fa fa-users kt-font-io" aria-hidden="true"></i>
                                                                                    ...
                                                                                    <div class="col-lg-12 row">
                                                                                        ...
                                                                                        <div class="col-lg-2 col-md-12 col-sm-12 kt-align-right" style="float: right;">
                                                                                            <a href="<%=request.getContextPath()%>/OperazioniMicro?type=scaricaFileAssenza&idpr=<%=request.getParameter("id")%>" id="scarica_ASSENZA_file" 
                                                                                               target="_blank" class="btn btn-info btn-icon kt-font-bold disablelink" data-container="body" data-html="true" 
