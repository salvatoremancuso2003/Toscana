                                            ...
                                            <form id="kt_form" action="<%=request.getContextPath()%>/OperazioniMicro?type=addCpiUser" class="kt-form kt-form--label-right" accept-charset="ISO-8859-1" method="post">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <input style="border: 1px solid" class="form-control obbligatory" name="nome">
                                                    </div>
                                                    <div class="col">
                                                        <label class="active">Cognome</label><label class="kt-font-danger kt-font-boldest">*</label>
                                                        <input style="border: 1px solid" class="form-control obbligatory" name="cognome">
                                                    </div>
                                                    <div class="col">
                                                        <label class="active">Email</label><label class="kt-font-danger kt-font-boldest">*</label>
                                                        <input style="border: 1px solid" class="form-control obbligatory" id="email" name="email">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <label class="active">CPI </label><label class="kt-font-danger kt-font-boldest">*</label>
