        ...
        $("input[type=file]").change(function (e) {
            ...
            if (e.target.files.length != 0) {
                ...
                if (e.target.files[0].name.length > 25) {
                    label.html(e.target.files[0].name.substring(0, 25) + "...");
                } else {
                    label.html(e.target.files[0].name);
                }
            } else {
                label.css("color", "#a7abc3");
                label.html("Scegli File");
            }
        });
        /* soluzione standard */
//        
    ...
    $.fn[pluginName] = function (options) {
        ...
        var Plugin = {
                    ...
                    $(tr).find('.' + pfx + 'datatable__cell').each(function (tdi, td) {
                        ...
                        if (typeof column !== 'undefined') {
                            ...
                            if (typeof column.subtable !== 'undefined' && column.subtable) {
                                ...
                                if ($(td).find('.' + pfx + 'datatable__toggle-subtable').length > 0)
                                    return;
            ...
            paging: function (meta, callback) {
                var pg = {
                    ...
                    gotoPage: function (e) {
                        ...
                        if ($(this).hasClass(pfx + 'datatable__pager-link--active'))
                            return;
            ...
            setupSubDatatable: function () {
                ...
                if ($(datatable.table).find('.' + pfx + 'datatable__subtable').length > 0)
                    return;
